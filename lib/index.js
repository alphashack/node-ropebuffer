...
[
    ...
    p['read' + name + 'At'] = function (offset, noAssert) {
        var index = this._getInternalIndex(offset);
        return this._buffers[index.buffer]['read' + name](offset, noAssert);
    };
    ...
    p['write' + name + 'At'] = function (value, offset, noAssert) {
        var index = this._getInternalIndex(offset);
        return this._buffers[index.buffer]['write' + name](value, offset, noAssert);
    };
});
